    ...
    if not has_tray:
        ...
        class QuickstartTrayApp:
            def __init__(self):
                ...
                helpers.ts_log(f"Port and Debug Settings can be amended by right-clicking the system tray icon or by editing your {DOTENV} file", level="INFO")  # Open the browser automatically
